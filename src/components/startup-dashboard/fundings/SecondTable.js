...
export default function Table() {
  ...
  const headers = ["Unclosed Deals", "amount", "tenure", "round"];
  const bodyData = [
    {
  ...
  return (
    <div className="max-w-full w-full bg-white dark:bg-dark overflow-x-auto border border-[#F2F2F2] rounded-[6px]">
